    ...
    <main className="access-page">
      ...
      <section className="access-editorial" aria-labelledby="access-title">
        ...
        <div className="access-stats" aria-label="Dance Lab en quelques chiffres">
          ...
          <div><strong>100K</strong><span>Écoutes<br />cumulées</span></div>
          <div><strong>2M</strong><span>Vues sur<br />les réseaux</span></div>
        </div>
      </section>
      ...
      <section className="access-panel" aria-labelledby="private-access-title">
        ...
        <p className="access-panel-title" id="private-access-title">Accès privé</p>
        <span className="access-panel-rule" aria-hidden="true" />
        <p className="access-question">Vous avez un accès anticipé&nbsp;?</p>
        <form onSubmit={handleSubmit} className="access-form">
          <label className="sr-only" htmlFor="preview-password">Mot de passe</label>
        ...
        <p className="access-note">Accès réservé aux partenaires et contributeurs.</p>
      </section>

      <p className="access-signature">Le média<br />de référence<br />sur la danse <span /></p>
...
export default function AccesPrivePage() {
  return <Suspense><AccesPriveForm /></Suspense>
}
