...
/**
 * Image locale optimisée pour la carte "Dernier épisode".
 * Convention : /images/les-invites/{prénom}{nom}{number}.png
 * Le fallback (CDN Ausha ou chemin hérité) est géré par onError dans LatestEpisodeSticky.
 */
function getLatestEpisodeImage(episode: UnifiedEpisode): string {
